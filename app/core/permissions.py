...
# Логистика (ВкусВилл, рейсы, маршруты)
PERM_LOGISTICS_READ  = "logistics:read"   # Просмотр рейсов, маршрутов, тарифов
PERM_LOGISTICS_WRITE = "logistics:write"  # Создание/редактирование рейсов и маршрутов

# MIKS — корпоративный мессенджер
PERM_MIKS_READ = "miks:read"  # Доступ к MIKS-чату и AI-советнику Mix
...
class DominionRole(str, Enum):
    ...
    # Логист — доступ к модулю логистики ВкусВилл и MIKS
    LOGIST = "logist"
...
ROLE_PERMISSIONS: dict[str, Set[str]] = {
    ...
    # ══════════════════════════════════════════════════════════════════
    # LOGIST — Логист ВкусВилл (С-ГЛОБАЛ EXPRESS)
    # Доступ к модулю логистики, MIKS-чату и HR-метрикам (ЗП водителей)
    # Алгоритм 50/50: маржа рейсов ВкусВилл
    # ══════════════════════════════════════════════════════════════════
    DominionRole.LOGIST: {
        PERM_LOGISTICS_READ,
